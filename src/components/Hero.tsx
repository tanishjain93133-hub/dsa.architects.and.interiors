    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-obsidian">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
        <div className="flex flex-col items-center text-center">
          ...
          >
            <a href="https://projects-rho-dun.vercel.app/" target="_blank" rel="noopener noreferrer" className="group relative px-12 py-5 rounded-full overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-lg">
